...
<table>
  <tr>
    <td align="center">
      <b>1. Deep Audit: +510 Million Records</b><br><br>
      <img src="./assets/captura_510M.png" width="250" alt="DuckDB Audit">
    </td>
    <td align="center">
      <b>2. Local Data Lake Infrastructure</b><br><br>
      <img src="./assets/captura_datalake.png" width="250" alt="Parquet Infrastructure">
    </td>
    <td align="center">
      <b>3. REST API Deployment (FastAPI)</b><br><br>
      <img src="./assets/captura_swagger.png" width="250" alt="FastAPI Swagger UI">
    </td>
  </tr>
  <tr>
    <td align="center" colspan="3">
      <b>4. Data Assimilation Pipelines (ETL)</b><br><br>
      <img src="./assets/captura_pipeline1.png" width="250" alt="ETL Pipeline 1"> &nbsp;&nbsp;&nbsp;
      <img src="./assets/captura_pipeline2.png" width="250" alt="ETL Pipeline 2">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      <b>1. Auditoria: +510 Milhões de Registros</b><br><br>
      <img src="./assets/captura_510M.png" width="250" alt="Auditoria DuckDB">
    </td>
    <td align="center">
      <b>2. Infraestrutura do Data Lake Local</b><br><br>
      <img src="./assets/captura_datalake.png" width="250" alt="Infraestrutura Parquet">
    </td>
    <td align="center">
      <b>3. Implantação de API REST (FastAPI)</b><br><br>
      <img src="./assets/captura_swagger.png" width="250" alt="Implantação FastAPI">
    </td>
  </tr>
  <tr>
    <td align="center" colspan="3">
      <b>4. Pipelines de Assimilação de Dados (ETL)</b><br><br>
      <img src="./assets/captura_pipeline1.png" width="250" alt="Pipeline ETL 1"> &nbsp;&nbsp;&nbsp;
      <img src="./assets/captura_pipeline2.png" width="250" alt="Pipeline ETL 2">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      <b>1. Auditoría: +510 Millones de Registros</b><br><br>
      <img src="./assets/captura_510M.png" width="250" alt="Auditoría DuckDB">
    </td>
    <td align="center">
      <b>2. Infraestructura del Data Lake Local</b><br><br>
      <img src="./assets/captura_datalake.png" width="250" alt="Infraestructura Parquet">
    </td>
    <td align="center">
      <b>3. Despliegue de API REST (FastAPI)</b><br><br>
      <img src="./assets/captura_swagger.png" width="250" alt="Despliegue FastAPI">
    </td>
  </tr>
</table>
